...
Dans ce cas très très particulier d'afficher un shortcode dans un widget texte sans l'exécuter il y a un tricks efficace: mettre le shortcode entre double [] comme ça :
`
[[myshortcode]]
`
