		...
		<section class="postbox">
			...
			<?php settings_fields('jm-ltsc'); ?>
				...
				<p>
					...
					<input id="consumerKey" type="text" name="jm_ltsc[consumerKey]" class="paDemi" value="<?php echo $opts['consumerKey']; ?>" />
				</p>
				<p>
					<label for="consumerSecret"><?php _e('Provide your application consumer secret', 'jm-ltsc'); ?> :</label>
					<input id="consumerSecret" type="text" name="jm_ltsc[consumerSecret]" class="paDemi" value="<?php echo $opts['consumerSecret']; ?>" />
				</p>
				<p>
					<label for="oauthToken"><?php _e('Provide your oAuth Token', 'jm-ltsc'); ?> :</label>
					<input id="oauthToken" type="text" name="jm_ltsc[oauthToken]" class="paDemi"  value="<?php echo $opts['oauthToken']; ?>" />
				</p>
				<p>
					<label for="oauthToken_secret"><?php _e('Provide your oAuth Token Secret', 'jm-ltsc'); ?> :</label>
					<input id="oauthToken_secret" type="text" name="jm_ltsc[oauthToken_secret]" class="paDemi"  value="<?php echo $opts['oauthToken_secret']; ?>" />
				</p>
				<p>
